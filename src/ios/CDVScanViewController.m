...
- (void)viewDidLoad
{
    ...
    [leftButton setImage:[UIImage imageNamed:@"scanSources.bundle/backArrow"] forState:UIControlStateNormal];
...
- (void)setupMaskView{
    ...
    //操作提示
    UILabel * tipLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, SCREENHeight*0.8-kBorderW*2, SCREENWidth, kBorderW)];
    tipLabel.text = @"请将二维码/条形码放入框内, 即可自动识别";
    ...
    flashBtn.frame = CGRectMake((SCREENWidth-40)/2,SCREENHeight*0.9-kBorderW*2+80, 40, 40);
    [flashBtn setBackgroundImage:[UIImage imageNamed:@"scanSources.bundle/sgd"] forState:UIControlStateNormal];
...
- (void)setupScanWindowView{
    ...
    UIImageView *scanNetImageView = [[UIImageView alloc]initWithImage:[UIImage imageNamed:@"scanSources.bundle/scanLine"]];
    ...
    [topLeft setImage:[UIImage imageNamed:@"scanSources.bundle/left-up"]forState:UIControlStateNormal];
    ...
    [topRight setImage:[UIImage imageNamed:@"scanSources.bundle/right-up"]forState:UIControlStateNormal];
    [scanWindow addSubview:topRight];
    
    UIButton *bottomLeft = [[UIButton alloc]initWithFrame:CGRectMake(0,QRCodeWidth - buttonWH, buttonWH, buttonWH)];
    [bottomLeft setImage:[UIImage imageNamed:@"scanSources.bundle/left-down"]forState:UIControlStateNormal];
    ...
    [bottomRight setImage:[UIImage imageNamed:@"scanSources.bundle/right-down"]forState:UIControlStateNormal];
