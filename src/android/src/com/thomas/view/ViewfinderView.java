	...
	public void onDraw(Canvas canvas) {
		...
		if (resultBitmap != null) {
			...
			*/
			...
			String textPileCode = getResources().getString(getId("scan_text","string"));
			float textWidth = paint.measureText(textPileCode);
			canvas.drawText(textPileCode, frame.left+(frame.right-frame.left-textWidth)/2, (float) ( 50 + frame.bottom + (float)TEXT_PADDING_TOP *density), paint);
